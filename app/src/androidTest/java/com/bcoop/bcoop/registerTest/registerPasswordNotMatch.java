...
public class registerPasswordNotMatch {
    ...
    public void executeTest() throws InterruptedException {
        ...
        onView(withId(R.id.register_confirm_password)).perform(typeText(password2), ViewActions.closeSoftKeyboard());
        onView(withId(R.id.register)).perform(click());
        onView(withId(R.id.register_confirm_password)).check(matches(hasErrorText("Confirmation password does not match")));
    }
}
